...
protected:
    ...
    void method_impl(
        util::cstring_view decl, Fn&& fn, call_conv_t<CallConv>, void* aux = nullptr
    ...
    void property_impl(util::cstring_view decl, std::size_t off)
    {
        [[maybe_unused]]
    ...
    void property_impl(util::cstring_view decl, MemberPointer mp)
    {
        property_impl(decl, member_offset(mp));
    }

    void comp_property_impl(util::cstring_view decl, std::size_t off, std::size_t comp_off)
    {
        [[maybe_unused]]
        int r = m_engine->RegisterObjectProperty(
            m_name.c_str(),
    ...
    void comp_property_impl(util::cstring_view decl, std::size_t off, CompMemberPointer comp_mp)
    {
    ...
    template <typename MemberPointer>
    requires(std::is_member_object_pointer_v<MemberPointer>)
    void comp_property_impl(util::cstring_view decl, MemberPointer mp, std::size_t comp_off)
    {
    ...
    void comp_property_impl(util::cstring_view decl, MemberPointer mp, CompMemberPointer comp_mp)
    {
...
#undef ASBIND20_CLASS_BINARY_OP_IMPL
    ...
    void member_funcdef_impl(util::cstring_view decl)
    {
        full_funcdef(
...
#undef ASBIND20_VALUE_CLASS_BEH
    ...
    basic_value_class& property(util::cstring_view decl, std::size_t off)
    {
    ...
    template <typename MemberPointer>
    requires(std::is_member_object_pointer_v<MemberPointer>)
    basic_value_class& property(util::cstring_view decl, MemberPointer mp)
    {
    ...
    basic_value_class& property(
        util::cstring_view decl, std::size_t off, composite_wrapper comp
    )
    {
    ...
    template <typename MemberPointer>
    requires(std::is_member_object_pointer_v<MemberPointer>)
    basic_value_class& property(util::cstring_view decl, MemberPointer mp, composite_wrapper comp)
    {
    ...
    basic_value_class& funcdef(util::cstring_view decl)
    {
...
#undef ASBIND20_REFERENCE_CLASS_BEH
    ...
    basic_ref_class& property(util::cstring_view decl, std::size_t off)
    {
        this->property_impl(decl, off);
    ...
    template <typename MemberPointer>
    requires(std::is_member_object_pointer_v<MemberPointer>)
    basic_ref_class& property(util::cstring_view decl, MemberPointer mp)
    {
        this->template property_impl<MemberPointer>(decl, mp);
    ...
    template <typename MemberPointer>
    requires(std::is_member_object_pointer_v<MemberPointer>)
    basic_ref_class& property(util::cstring_view decl, MemberPointer mp, composite_wrapper comp)
    {
        this->comp_property_impl(decl, mp, comp.get_offset());
    ...
    basic_ref_class& funcdef(util::cstring_view decl)
    {
        this->member_funcdef_impl(decl);
