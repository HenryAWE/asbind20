...
.. list-table::
  ...
  * - ``asbind_cxxstd``
    - C++ standard version for building asbind20. Must be at least 20. |br|
      This can be set to a higher version like 23, |br| testing some advanced features that are only available in a newer standard.
  * - ``asbind_build_test``
...
This is used by Read the Docs, but you can also generate a local version for previewing modifications to the documents.

First, follow the installation guide for your platform to install Doxygen, Python and Sphinx.
Then, use ``pip`` to install the remaining documentation dependencies.
...
You can preview the generated documentation in a browser.
