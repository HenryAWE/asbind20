void main()
{
    ...
    assert(close_to(numbers::PI_f, 3.14f, 0.01f));
    assert(close_to(numbers::E_f, 2.71f, 0.01f));
    ...
    assert(close_to(log(numbers::E_f), 1.0f, 0.001f));

    assert(isfinite(1.0f));
    assert(isinf(numbers::INFINITY_f));
