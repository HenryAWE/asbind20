...
4. GCC (at least for 14.2) may have problem for not generating machine code of registered template class on rare occasion. If your encounter a linker error like [this example on Compiler Explorer](https://godbolt.org/z/oT9cP1rso), try to use explicit instantiation for your template class.
